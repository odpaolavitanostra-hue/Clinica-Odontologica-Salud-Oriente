          ...
          <div className="relative z-10 container mx-auto px-4 pt-24 lg:pt-32 pb-16 lg:pb-24">
            <div className="max-w-3xl mx-auto text-center">
              <img
                src={logoHeaderWhite}
                alt="Clínica Odontológica Salud Oriente"
                className="h-[120px] md:h-[150px] lg:h-[180px] w-auto object-contain mx-auto mb-4 drop-shadow-[0_2px_12px_rgba(232,192,86,0.25)]"
              />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-14 lg:mt-20 max-w-4xl mx-auto animate-fade-up-delay-3">
              ...
              <InfoCard icon={<Clock className="w-5 h-5 text-gold" />} title="Horario" text="Lun-Vie 8:00–17:00 · Sáb 9:00–14:00" />
            </div>
          </div>
        </section>
